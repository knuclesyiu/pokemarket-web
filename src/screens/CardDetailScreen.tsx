...
const styles = StyleSheet.create({
  ...
  cardName: { color: '#FFFFFF', fontSize: 16, fontWeight: '800', lineHeight: 20 },
  cardSet: { color: '#8888AA', fontSize: 11, marginTop: 4 },
  cardRarity: {
    color: '#FFD700',
    fontSize: 11,
    fontWeight: '600',
  ...
  tabText: { color: '#8888AA', fontSize: 12, fontWeight: '600' },
  ...
  listingLeft: {},
  listingSeller: { color: '#FFFFFF', fontSize: 14, fontWeight: '600' },
  listingCondition: { color: '#8888AA', fontSize: 11, marginTop: 2 },
  listingRight: { alignItems: 'flex-end' },
  listingPrice: { color: '#FFFFFF', fontSize: 16, fontWeight: '700' },
  bidBtn: { marginTop: 6 },
  ...
  chartRange: { color: '#8888AA', fontSize: 11, marginTop: 2 },
  detailSection: {
    marginHorizontal: 16,
    backgroundColor: '#1E1E2E',
    borderRadius: 16,
  ...
  detailTitle: { color: '#FFFFFF', fontSize: 14, fontWeight: '700', marginBottom: 12 },
  detailRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    paddingVertical: 8,
  ...
  detailLabel: { color: '#8888AA', fontSize: 12 },
...
const modalStyles = StyleSheet.create({
  ...
  subtitle: { color: '#8888AA', fontSize: 13, marginBottom: 20 },
  option: {
    backgroundColor: '#2A2A3E',
    borderRadius: 14,
    padding: 16,
  ...
  optionTitle: { color: '#FFFFFF', fontSize: 15, fontWeight: '700', marginBottom: 4 },
